...
export const StudyProgram = () => {
    ...
    return (
        <section className={styles.program}>
            <h2 className={clsx(styles.program__header, styles.container)}>
                ...
                <span className={styles.program__fourthLine}>
                    Факультет: Информационных технологий
                </span>
            </h2>
            <div className={styles.program__content}>
                <div className={clsx(styles.program__card, styles.container)}>
                    ...
                    <p className={styles.program__cardText}>
                        ...
                        программного обеспечения. Выпускники этой программы
                        обладают практическими навыками в области подготовки
                        и создания компьютерных игр под различные платформы
                        и технические устройства, обработки аудио- и видео
                        контента, создания анимации и видеоэффектов.
                    </p>
